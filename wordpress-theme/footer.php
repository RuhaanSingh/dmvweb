<footer class="main-footer">
    <div class="footer-content">
            ...
            <div class="footer-column">
                ...
                <div class="footer-contact">
                    <div class="contact-item">
                        ...
                        <a href="tel:+15716851515" class="contact-link">(571) 685-1515</a>
                    </div>
                    <div class="contact-item">
                        <span class="contact-icon">✉️</span>
                        <a href="mailto:dmvwebdesign.operations@gmail.com" class="contact-link">dmvwebdesign.operations@gmail.com</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="footer-bottom">
            <p class="copyright">
                © <?php echo date('Y'); ?> DMV Web Designs. All rights reserved.
            </p>
        </div>
    </div>
</footer>
